...
class Post(models.Model):
    ...
    status = models.PositiveIntegerField(default=STATUS_NORMAL, choices=STATUS_ITEMS, verbose_name="状态")
    category = models.ForeignKey(Category, verbose_name="个人分类", on_delete=models.CASCADE)
    pro_category = models.ForeignKey(ProjectCategory, verbose_name="系统分类", on_delete=models.CASCADE)
